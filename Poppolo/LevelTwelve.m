...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if(touchedNode != self){
        ...
        if(ballCount ==0){
            ...
            levelLabel.text = [NSString stringWithFormat:@"13"];
...
-(void)segueToNextLevel{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        LevelThirteen *newScene = [[LevelThirteen alloc] initWithSize:self.scene.size];
