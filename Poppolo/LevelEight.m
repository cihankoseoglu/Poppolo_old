...
// Level 8 is a Timed Level .
// Same as Level 5 but timed to 10 seconds.
...
- (void)addBall {
    ...
    ballSprite.physicsBody.restitution = 0.95;
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if(touchedNode != self){
        ...
        if(ballCount ==0){
            ...
            levelLabel.text = [NSString stringWithFormat:@"9"];
